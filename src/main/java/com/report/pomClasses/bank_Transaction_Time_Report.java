...
public class bank_Transaction_Time_Report {
	...
	//todays date verify
	@FindBy(xpath = "//span[text()='02-07-2025 00:00']")
	...
	//select bank
	@FindBy(xpath="//select[@id='bnk']")private WebElement selectbank;
	
	
	//Transaction Time more than
	@FindBy(xpath="//input[@id='moreThanSeconds']")private WebElement enterTime;
	...
	public bank_Transaction_Time_Report(WebDriver driver) {
	...
	public void navigateUptoBankTransactionTimeReport(WebDriver driver) throws InterruptedException {
		...
		Assert.assertTrue(bank_Transaction_Time_Report.isDisplayed(),"user is not on the Bank Transaction Time Report this page");
